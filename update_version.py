...
def main():
  ...
  plistpath = scriptpath + "/resources/Rain-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Rain-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Rain-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Rain-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Rain-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Rain-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Rain-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Rain.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Rain.iss",inplace=1):
